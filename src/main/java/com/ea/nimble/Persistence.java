...
public class Persistence implements LogSource {
    ...
    */
    ...
    /* JADX WARN: Type inference failed for: r9v13, types: [java.io.ObjectOutputStream] */
    ...
    private void savePersistenceData() {
        ...
        String e2 = getPersistencePath(this.m_identifier, this.m_storage);
        if (e2 != null) {
            try {
                file = new File((String) e2);
            ...
            try {
                ...
                ObjectOutputStream objectOutputStream1 = this.m_encryption ? this.m_encryptor.encryptOutputStream(bufferedOutputStream) : new ObjectOutputStream(bufferedOutputStream);
                objectOutputStream1.writeObject(this.m_content);

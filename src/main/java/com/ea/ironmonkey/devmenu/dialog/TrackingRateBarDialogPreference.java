...
public class TrackingRateBarDialogPreference extends DialogPreference {
    private static final int DEFAULT_MIN_PROGRESS = 0;
    private static final int DEFAULT_MAX_PROGRESS = 5000;
    private static final int DEFAULT_PROGRESS = UtilitiesAndData.getObjectFromSharedPrefs(R.string.tracking_rate_ms);
    ...
    public TrackingRateBarDialogPreference(Context context) {
        this(context, null);
    }

    public TrackingRateBarDialogPreference(Context context, AttributeSet attrs) {
        super(context, attrs);

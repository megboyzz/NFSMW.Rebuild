...
class GraphObjectAdapter<T extends GraphObject> extends BaseAdapter implements SectionIndexer {
    ...
    protected View getSectionHeaderView(String sectionHeader, View convertView, ViewGroup parent) {
        ...
        if (result == null) {
            result = (TextView) inflater.inflate(0, null);
        }
    ...
    private View getActivityCircleView(View convertView, ViewGroup parent) {
        ...
        if (result == null) {
            result = inflater.inflate(0, null);
        }
        ProgressBar activityCircle = (ProgressBar) result.findViewById(0);
    ...
    protected View createGraphObjectView(T graphObject, View convertView) {
        ...
        ViewStub checkboxStub = (ViewStub) result.findViewById(0);
        ...
        ViewStub profilePicStub = (ViewStub) result.findViewById(0);
        if (!getShowPicture()) {
    ...
    protected void populateGraphObjectView(View view, T graphObject) {
        ...
        if (getShowPicture()) {
            ...
            if (pictureURL != null) {
                ImageView profilePic = (ImageView) view.findViewById(0);
    ...
    String getPictureFieldSpecifier() {
        ...
        ImageView picture = (ImageView) view.findViewById(0);
        if (picture == null) {
            return null;
        }

...
public abstract class PickerFragment<T extends GraphObject> extends Fragment {
    ...
    public void onInflate(Activity activity, AttributeSet attrs, Bundle savedInstanceState) {
        ...
        TypedArray a = activity.obtainStyledAttributes(new int[0]);

        setShowPictures(a.getBoolean(0, showPictures));
        String extraFieldsString = a.getString(0);
        if (extraFieldsString != null) {
            String[] strings = extraFieldsString.split(",");
            setExtraFields(Arrays.asList(strings));
        }

        showTitleBar = a.getBoolean(0, showTitleBar);
        titleText = a.getString(0);
        doneButtonText = a.getString(0);
        titleBarBackground = a.getDrawable(0);
        doneButtonBackground = a.getDrawable(0);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        listView = (ListView) view.findViewById(0);
        ...
        activityCircle = (ProgressBar) view.findViewById(0);
    ...
    private void inflateTitleBar(ViewGroup view) {
        ViewStub stub = (ViewStub) view.findViewById(0);
        if (stub != null) {
            ...
            doneButton = (Button) view.findViewById(0);
            if (doneButton != null) {
            ...
            titleTextView = (TextView) view.findViewById(0);
            if (titleTextView != null) {

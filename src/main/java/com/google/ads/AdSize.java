...
public final class AdSize {
    ...
    private AdSize(int n2, int n3, String string) {
        this(new com.google.android.gms.ads.AdSize(n2, n3));
    }
    ...
    public boolean equals(Object object) {
        ...
        return this.c.equals(((AdSize)object).c);
    }

    /*
     * Unable to fully structure code
     */
    public AdSize findBestSize(AdSize ... var1_1) {
        var11_2 = null;
        var12_3 = null;
        if (var1_1 == null) {
            return var12_3;
    ...
    public boolean isSizeAppropriate(int n2, int n3) {
        ...
        if (!((float)n2 <= (float)n4 * 1.25f)) return false;
        if (!((float)n2 >= (float)n4 * 0.8f)) return false;
        if (!((float)n3 <= (float)n5 * 1.25f)) return false;
        if (!((float)n3 >= (float)n5 * 0.8f)) return false;
        return true;
    }

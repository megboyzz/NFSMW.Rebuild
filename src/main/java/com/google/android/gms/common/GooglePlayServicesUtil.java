...
public final class GooglePlayServicesUtil {
    ...
    public static Dialog a(int n2, Activity object, int n3, DialogInterface.OnCancelListener object2, int n4) {
        AlertDialog.Builder builder = new AlertDialog.Builder((Context)object).setMessage((CharSequence)GooglePlayServicesUtil.b((Context)object, n2, n4));
        if (object2 != null) {
            builder.setOnCancelListener(object2);
        }
        object2 = new di((Activity)object, GooglePlayServicesUtil.a((Context)object, n2, n4), n3);
        if ((object = GooglePlayServicesUtil.b((Context)object, n2)) != null) {
            builder.setPositiveButton((CharSequence)object, (DialogInterface.OnClickListener)object2);
        }
        switch (n2) {
            default: {
                Log.e((String)"GooglePlayServicesUtil", (String)("Unexpected error code " + n2));
                return builder.setTitle(R.string.common_google_play_services_unknown_issue).create();
            }
            case 0: {
                return null;
            }
        ...
        Log.e((String)"GooglePlayServicesUtil", (String)"The date of the device is not valid.");
        return builder.setTitle(R.string.common_google_play_services_unsupported_title).create();
    }
    ...
    public static Intent a(Context context, int n2, int n3) {
        switch (n2) {
            ...
            case 1: 
            case 2: {
                if (!GooglePlayServicesUtil.q(n3)) return dn.G(GOOGLE_PLAY_SERVICES_PACKAGE);
                if (!GooglePlayServicesUtil.o(context)) return dn.G("com.google.android.apps.bazaar");
                return dn.H(GOOGLE_PLAY_SERVICES_PACKAGE);
            }
            case 3: {
                return dn.E(GOOGLE_PLAY_SERVICES_PACKAGE);
            }
            case 12: 
        }
        return dn.bK();
    ...
    public static boolean a(Resources resources) {
        boolean bl2 = false;
        boolean bl3 = (resources.getConfiguration().screenLayout & 0xF) > 3;
        if (es.ck()) {
            if (bl3) return true;
        }
        if (!GooglePlayServicesUtil.b(resources)) return bl2;
        return true;
    }
     ...
     */
    private static byte[] a(PackageInfo object, byte[] ... byArray) {
        Object object2;
        try {
        ...
        ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(object.signatures[0].toByteArray());
        try {
            object2 = (X509Certificate)((CertificateFactory)object2).generateCertificate(byteArrayInputStream);
        }
        catch (CertificateException certificateException) {
        ...
        byte[] byArray2 = object.signatures[0].toByteArray();
        int n2 = 0;
        while (true) {
            void var1_6;
            if (n2 >= ((void)var1_6).length) {
                if (!Log.isLoggable((String)"GooglePlayServicesUtil", (int)2)) return null;
    ...
    private static byte[][] a(byte[][] ... byArray) {
        ...
        int n4 = 0;
        for (n2 = 0; n2 < n3; n4 += byArray[n2].length, ++n2) {
        }
        ...
        while (n4 < n5) {
            ...
            for (n3 = 0; n3 < byArray2.length; ++n3, ++n2) {
                byArrayArray[n2] = byArray2[n3];
            }
            ++n4;
        }
        return byArrayArray;
    ...
    public static boolean aU() {
        if (!ki) return "user".equals(Build.TYPE);
        return kj;
    }
    ...
    public static String b(Context object, int n2, int n3) {
        Object object2 = object.getResources();
        switch (n2) {
            default: {
                return object2.getString(R.string.common_google_play_services_unknown_issue);
            }
            case 1: {
                object2 = GooglePlayServicesUtil.a(object.getResources()) ? object2.getString(R.string.common_google_play_services_install_text_tablet) : object2.getString(R.string.common_google_play_services_install_text_phone);
                object = object2;
                if (!GooglePlayServicesUtil.q(n3)) return object;
                return (String)object2 + " (via Bazaar)";
            }
            case 3: {
                return object2.getString(R.string.common_google_play_services_enable_text);
            }
            case 2: {
                object2 = object2.getString(R.string.common_google_play_services_update_text);
                object = object2;
                if (!GooglePlayServicesUtil.q(n3)) return object;
                return (String)object2 + " (via Bazaar)";
            }
            case 9: {
                return object2.getString(R.string.common_google_play_services_unsupported_text);
            }
            case 7: {
                return object2.getString(R.string.common_google_play_services_network_error_text);
            }
            case 5: {
                return object2.getString(R.string.common_google_play_services_invalid_account_text);
            }
            case 12: 
        }
        return object2.getString(R.string.common_google_play_services_unsupported_date_text);
    }
    ...
    private static boolean b(Resources resources) {
        ...
        if (!es.cm()) return bl3;
        bl3 = bl2;
        if ((resources.screenLayout & 0xF) > 3) return bl3;
        bl3 = bl2;
        if (resources.smallestScreenWidthDp < 600) return bl3;
        return true;
    }

    public static Dialog getErrorDialog(int n2, Activity activity, int n3) {
        return GooglePlayServicesUtil.a(n2, activity, n3, null, -1);
    }

    public static Dialog getErrorDialog(int n2, Activity activity, int n3, DialogInterface.OnCancelListener onCancelListener) {
        return GooglePlayServicesUtil.a(n2, activity, n3, onCancelListener, -1);
    }
    ...
    public static PendingIntent getErrorPendingIntent(int n2, Context context, int n3) {
        ...
        if (intent != null) return PendingIntent.getActivity((Context)context, (int)n3, (Intent)intent, (int)0x10000000);
        return null;
    }
    ...
    public static String getOpenSourceSoftwareLicenseInfo(Context object) {
        ...
        object = new Scanner(inputStream).useDelimiter("\\A").next();
        uri = object;
    ...
    public static int isGooglePlayServicesAvailable(Context object) {
        ...
        GooglePlayServicesUtil.n(object);
        try {
        ...
        byte[] byArray = GooglePlayServicesUtil.a(packageInfo2, kb);
        if (byArray == null) {
    ...
    public static void m(Context context) throws GooglePlayServicesRepairableException, GooglePlayServicesNotAvailableException {
        ...
        if (n2 == 0) return;
        context = GooglePlayServicesUtil.a(context, n2, -1);
        Log.e((String)"GooglePlayServicesUtil", (String)("GooglePlayServices not available due to error " + n2));
        if (context != null) throw new GooglePlayServicesRepairableException(n2, "Google Play Services not available", (Intent)context);
...
lbl4:
            ...
            while (true) {
                var0 = var0.metaData;
                if (var0 == null) throw new IllegalStateException("A required meta-data tag in your app's AndroidManifest.xml does not exist.  You must have the following declaration within the <application> element:     <meta-data android:name=\"com.google.android.gms.version\" android:value=\"@integer/google_play_services_version\" />");
                break;
            }
        }
        catch (PackageManager.NameNotFoundException var0_1) {
            Log.wtf((String)"GooglePlayServicesUtil", (String)"This should never happen.", (Throwable)var0_1);
            var0 = var2_2;
            ** continue;
        }
        var1_3 = var0.getInt("com.google.android.gms.version");
        if (var1_3 != 4132500) throw new IllegalStateException("The meta-data tag in your app's AndroidManifest.xml does not have the right value.  Expected 4132500 but found " + var1_3 + ".  You must have the" + " following declaration within the <application> element: " + "    <meta-data android:name=\"" + "com.google.android.gms.version" + "\" android:value=\"@integer/google_play_services_version\" />");
    }

    private static boolean o(Context object) {
        boolean bl2 = false;
        if (ki) {
            return kk;
        }
        try {
            if ((object = (Object)GooglePlayServicesUtil.a(object.getPackageManager().getPackageInfo("com.google.android.apps.bazaar", 64), kh)) == null) return bl2;
            return true;
        }
        catch (PackageManager.NameNotFoundException nameNotFoundException) {
            return false;
    ...
    static boolean q(int n2) {
        boolean bl2;
        boolean bl3 = bl2 = true;
        switch (GooglePlayServicesUtil.r(n2)) {
            default: {
                bl3 = false;
            }
            case 1: {
            ...
            case 0: {
                bl3 = bl2;
                if (!GooglePlayServicesUtil.aU()) return bl3;
                return false;
            }
            case 2: 
        }
    ...
    private static int r(int n2) {
        int n3 = n2;
        if (n2 != -1) return n3;
        return 2;
    }

    private static byte[] y(String object) {
        try {

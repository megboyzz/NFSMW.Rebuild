...
public final class GooglePlayServicesUtil {
    ...
    public static Dialog a(int i, Activity activity, int i2, DialogInterface.OnCancelListener onCancelListener, int i3) {
        ...
        di diVar = new di(activity, a(activity, i, i3), i2);
        String b = b(activity, i);
        if (b != null) {
            message.setPositiveButton(b, diVar);
        }
    ...
    public static Intent a(Context context, int i, int i2) {
        switch (i) {
            case 1:
            case 2:
                return q(i2) ? o(context) ? dn.H(GOOGLE_PLAY_SERVICES_PACKAGE) : dn.G("com.google.android.apps.bazaar") : dn.G(GOOGLE_PLAY_SERVICES_PACKAGE);
            case 3:
        ...
        try {
            ...
            try {
                try {
                    ...
                    if (!Log.isLoggable("GooglePlayServicesUtil", Log.VERBOSE)) {
                        return null;
                    }
    ...
    public static boolean aU() {
        return ki ? kj : "user".equals(Build.TYPE);
    }
    ...
    public static PendingIntent getErrorPendingIntent(int i, Context context, int i2) {
        ...
        return PendingIntent.getActivity(context, i2, a, PendingIntent.FLAG_CANCEL_CURRENT);
    }
    ...
    public static Context getRemoteContext(Context context) {
        try {
            return context.createPackageContext(GOOGLE_PLAY_SERVICES_PACKAGE, Context.CONTEXT_INCLUDE_CODE);
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        n(context);
        try {
            byte[] a = a(packageManager.getPackageInfo(GOOGLE_PLAY_STORE_PACKAGE, PackageManager.GET_DISABLED_COMPONENTS), kb);
            if (a == null) {
                Log.w("GooglePlayServicesUtil", "Google Play Store signature invalid.");
                return 9;
            }
            try {
                PackageInfo packageInfo = packageManager.getPackageInfo(GOOGLE_PLAY_SERVICES_PACKAGE, PackageManager.GET_DISABLED_COMPONENTS);
                if (a(packageInfo, a) == null) {
                    Log.w("GooglePlayServicesUtil", "Google Play services signature invalid.");
                    return 9;
                } else if (packageInfo.versionCode < 4132500) {
    ...
    private static void n(Context context) {
        ...
        if (bundle != null) {
            ...
            if (i != 4132500) {
                throw new IllegalStateException("The meta-data tag in your app's AndroidManifest.xml does not have the right value.  Expected 4132500 but found " + i + ".  You must have the following declaration within the <application> element:     <meta-data android:name=\"com.google.android.gms.version\" android:value=\"@integer/google_play_services_version\" />");
            }
            return;
        }
    ...
    private static boolean o(Context context) {
        ...
        if (ki) {
            ...
            try {
                if (a(context.getPackageManager().getPackageInfo("com.google.android.apps.bazaar", PackageManager.GET_DISABLED_COMPONENTS), kh) != null) {
                    return true;
                }
            } catch (PackageManager.NameNotFoundException e) {
                return false;
